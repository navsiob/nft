...
/// @title A decentralized marketplace for NFTs
contract Marketplace is ReentrancyGuard {
    ...
    /// @param _feePercent The percentage of the fee charged on sales
    ...
    /// @dev Make item available for sale on the marketplace
    ...
    /// @dev Get the total price of an item, including the fee
